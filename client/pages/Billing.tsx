...
export default function Billing() {
  ...
  useEffect(() => {
    ...
    if (currentInvoice.billingMode === "GST") {
      ...
      const isInterState = currentInvoice.customer?.address?.includes("Delhi") && 
  ...
  }, [currentInvoice.items, currentInvoice.discountPercent, currentInvoice.billingMode, currentInvoice.customer]);
    ...
    <div className="p-4 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Create GST and Non-GST invoices</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <CardContent>
                <Select
                  ...
                  onValueChange={(value: "GST" | "Non-GST") => 
                    setCurrentInvoice(prev => ({ ...prev, billingMode: value }))
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
                        ...
                        {filteredProducts.map(product => (
                          <div
                            ...
                            className={cn(
                              ...
                              selectedProduct?.id === product.id && "border-primary bg-primary/10"
                            )}
                          >
        ...
        <div className="space-y-4">
          ...
          <Card>
            ...
            <CardContent>
              <Badge variant={currentInvoice.billingMode === "GST" ? "default" : "secondary"}>
          ...
          {invoicePreview && (
            <div className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">Electronic Shop Management</p>
                <div className="mt-4">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  {invoicePreview.customer ? (
                    <div>
                      <p className="font-medium">{invoicePreview.customer.name}</p>
                      <p>{invoicePreview.customer.phone}</p>
                      <p className="text-xs">{invoicePreview.customer.address}</p>
                    </div>
                  ) : (
                ...
                <div className="text-right">
                  ...
                  <p>Date: {invoicePreview.createdAt.toLocaleDateString('en-IN')}</p>
