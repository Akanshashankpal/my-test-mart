  ...
  return (
    <div
      className={cn(
        ...
        clickable &&
          "cursor-pointer hover:shadow-md active:scale-98 tap-target",
        "mobile-card",
        className,
      )}
      onClick={onClick}
...
export function ResponsiveText({
  ...
  return <span className={cn(sizeClasses, className)}>{children}</span>;
}
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div
        className={cn(
          ...
          fullScreenOnMobile &&
            "sm:max-w-md sm:mx-4 sm:max-h-[90vh] max-w-full mx-0 h-full sm:h-auto sm:rounded-lg rounded-none",
          className,
        )}
      >
        {/* Header */}
...
export const mobileStyles = {
  ...
  input:
    "mobile-input w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500",
  button:
    "tap-target min-h-[44px] px-4 py-2 rounded-lg font-medium transition-all duration-200",
  text: {
